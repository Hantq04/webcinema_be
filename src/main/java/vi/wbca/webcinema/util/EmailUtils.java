...
public class EmailUtils {
    ...
    public static String getChangePasswordMessage(String otp) {
        ...
        public static String getConfirmPaymentMessage(String detail, String printTicketHref) {
                return getConfirmPaymentMessage(detail, printTicketHref, "print-ticket.pdf");
        }

        public static String getConfirmPaymentMessage(String detail, String printTicketHref, String fileName) {
        return String.format(
                "<h3>Thank you for your payment!</h3>" +
                        ...
                        "<a href=\"%s\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"display:inline-block;background:#f3f4f6;color:#374151;text-decoration:none;padding:8px 16px;border:1px solid #d1d5db;border-radius:6px;font-weight:600;line-height:1.1;\">Print Ticket</a>" +
                        "</div>" +
                        "</div>" +
                        "<p>If you have any questions, feel free to contact our support team.</p>" +
                        "<p>Regards,<br>CineGo Support Team</p>",
                        detail, printTicketHref, fileName
        );
    }
}
