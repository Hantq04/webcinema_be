...
public enum ErrorCode {
    ...
    ROLE_NOT_FOUND(1203, "error.1203", HttpStatus.NOT_FOUND),
    USERNAME_NOT_FOUND(1204, "error.1204", HttpStatus.NOT_FOUND),
    OTP_NOT_FOUND(1205, "error.1205", HttpStatus.NOT_FOUND),
    USER_ACTIVE(1206, "error.1206", HttpStatus.CONFLICT),
    EXPIRED_OTP(1207, "error.1207", HttpStatus.BAD_REQUEST),
    EMAIL_NOT_FOUND(1208, "error.1208", HttpStatus.NOT_FOUND),
    STATUS_NOT_FOUND(1209, "error.1209", HttpStatus.NOT_FOUND),
    ...
    USER_NOT_FOUND(1213, "error.1213", HttpStatus.NOT_FOUND),
    NAME_NOT_FOUND(1214, "error.1214", HttpStatus.NOT_FOUND),
    CODE_NOT_FOUND(1215, "error.1215", HttpStatus.NOT_FOUND),
    ENUM_NOT_EXISTED(1216, "error.1216", HttpStatus.BAD_REQUEST),
    NOT_FOUND(1217, "error.1217", HttpStatus.NOT_FOUND),
    TYPE_NOT_FOUND(1218, "error.1218", HttpStatus.NOT_FOUND),
    AUTH_TOKEN_EXCEPTION(1219, "error.1219", HttpStatus.BAD_REQUEST),
    TOKEN_NOT_FOUND(1220, "error.1220", HttpStatus.NOT_FOUND),
    RATE_NOT_FOUND(1221, "error.1221", HttpStatus.NOT_FOUND),
    SCHEDULE_NOT_FOUND(1222, "error.1222", HttpStatus.NOT_FOUND),
    ROOM_NOT_FOUND(1223,"error.1223", HttpStatus.NOT_FOUND),
    SEAT_NOT_FOUND(1224, "error.1224", HttpStatus.NOT_FOUND),
    DUPLICATE_SHOWTIME(1225, "error.1225", HttpStatus.BAD_REQUEST),
    PROMOTION_NOT_FOUND(1226,"error.1226", HttpStatus.NOT_FOUND),
    NULL_POINTER(1227, "error.1227", HttpStatus.BAD_REQUEST),
    TITLE_NOT_FOUND(1228, "error.1228", HttpStatus.NOT_FOUND),
    SETTING_NOT_FOUND(1229, "error.1229", HttpStatus.NOT_FOUND),
    SHOW_TIME_IN_BREAK(1230, "error.1230", HttpStatus.BAD_REQUEST),
    BILL_NOT_FOUND(1231, "error.1231", HttpStatus.NOT_FOUND),
    BILL_EXISTED(1232, "error.1232", HttpStatus.BAD_REQUEST),
    BILL_FOOD_NOT_FOUND(1233, "error.1233", HttpStatus.NOT_FOUND),
    ID_NOT_FOUND(1234, "error.1234", HttpStatus.NOT_FOUND),
    START_TIME_NOT_FOUND(1235, "error.1235", HttpStatus.NOT_FOUND),
    ...
    SIZE_RANGE(1337, "error.1337", HttpStatus.BAD_REQUEST),
