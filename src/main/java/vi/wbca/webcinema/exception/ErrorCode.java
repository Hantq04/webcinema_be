...
public enum ErrorCode {
    ...
    INVALID_USERNAME(1303, "Username must be at least 3 characters.", HttpStatus.BAD_REQUEST),
    INVALID_EMAIL(1304, "Email must be at least 6 characters.", HttpStatus.BAD_REQUEST),
    INVALID_PASSWORD(1305, "Password must be at least 6 characters.", HttpStatus.BAD_REQUEST),
    INVALID_USERNAME_FORM(1306, "Invalid username format.", HttpStatus.BAD_REQUEST),
    INVALID_EMAIL_FORM(1307, "Invalid email format.", HttpStatus.BAD_REQUEST),
    INVALID_PHONE_FORM(1308, "Invalid phone number format.", HttpStatus.BAD_REQUEST),
    INVALID_PASSWORD_FORM(1309, "Invalid password format.", HttpStatus.BAD_REQUEST),
    INVALID_ROLE(1310, "Invalid role code.", HttpStatus.BAD_REQUEST),
